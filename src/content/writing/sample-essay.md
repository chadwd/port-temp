...
description: "How the best product design creates space for unexpected outcomes rather than prescribing every interaction."
date: 2024-07-20
tags: ["design philosophy", "systems thinking"]
---
...
1. **Start with principles, not mockups.** What are the core truths that must hold? What can flex?

2. **Design systems, not screens.** Create coherent patterns that can recombine in unexpected ways.

3. **Build in escape hatches.** Let people go off the happy path when they need to.

4. **Watch what emerges.** The best feature ideas come from observing how people actually use what you've built.
